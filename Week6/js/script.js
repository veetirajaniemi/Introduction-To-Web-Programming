...
const buildChart = async(areaCode) => {
    ...
    let areaName = Object.values(data.dimension.Alue.category.label)
...
submitButton.addEventListener("click", async() => {
    ...
    const areaCode = await getCode(areaName)
    buildChart(areaCode) // oikea kaupungin nimi isolla kirjoitettuna
